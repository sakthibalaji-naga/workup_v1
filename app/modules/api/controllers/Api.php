...
class Api extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $response_data = [
            'message' => 'Ticket Support API Version 1',
            'documentation' => '/api/v1/swagger.json',
            'endpoints' => [
                'create_ticket' => 'POST /api/v1/create_ticket',
                'get_ticket' => 'GET /api/v1/ticket/{ticket_number}',
                'get_divisions' => 'GET /api/v1/get_divisions',
                'get_departments' => 'GET /api/v1/get_departments?division_id={id}',
                'get_applications' => 'GET /api/v1/get_applications?department_id={id}',
                'get_services' => 'GET /api/v1/get_services?application_id={id}',
                'get_user_details' => 'GET /api/v1/get_user_details?userid={id}',
                'get_user_details_by_emp_code' => 'GET /api/v1/get_user_details_by_emp_code?emp_code={code}',
                'get_user_details_by_emp_phonenum' => 'GET /api/v1/get_user_details_by_emp_phonenum?emp_phonenum={number}'
            ]
        ];
        ...
        log_api_request('/api/v1/', 'GET', $api_key, [], $response_data, 200);
    }
