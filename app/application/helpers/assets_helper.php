...
function init_admin_auth_assets()
{
    ...
    // Add Font Awesome CSS for admin authentication
    $CI->app_css->add('fontawesome-css', 'assets/plugins/font-awesome/css/fontawesome.min.css', $groupName);
    $CI->app_css->add('fontawesome-solid', 'assets/plugins/font-awesome/css/solid.min.css', $groupName);
