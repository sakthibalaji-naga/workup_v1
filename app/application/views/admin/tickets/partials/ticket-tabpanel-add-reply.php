<div role="tabpanel"
    ...
    <?php
        $addResponseDisabled = !empty($ticket_is_closed) || (isset($close_request) && $close_request);
        $isReassignmentPending = isset($pending_reassignment) && $pending_reassignment;
        $replyButtonDisabled = $addResponseDisabled || ($ticket->merged_ticket_id != null) || $isReassignmentPending;
    ?>
    ...
    <?php } ?>
    <?php if ($addResponseDisabled) { ?>
    <div class="alert alert-info tw-mb-4">
        <?= _l('ticket_closed_no_responses'); ?>
    </div>
    <?php } ?>
    <div>
        ...
        <?php $show_predefined = get_option('enable_predefined_replies', '1') != '0'; ?>
        <?php $show_knowledge = get_option('enable_knowledge_base_links', '1') != '0' && $use_knowledge_base == '1'; ?>
        <?php if ($show_predefined || $show_knowledge) { ?>
        <div class="row mbot15">
            <?php if ($show_predefined) { ?>
            <div class="col-md-6">
            ...
            <div>
                <div class="row">
                    <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file"
                                                ...
                                                class="form-control" name="attachments[]" multiple
                        ...
                        <?php // Removed "Assign this ticket to me automatically" checkbox as requested ?>
                        <div class="checkbox">
                            <input type="checkbox"
                ...
                <div
                    ...
                    <div class="sm:tw-flex sm:tw-items-center sm:tw-justify-between tw-w-full sm:tw-space-x-2.5">
                        ...
                        <div
                            ...
                            <?php } ?>
                            <button type="submit" class="btn btn-primary tw-w-full sm:tw-w-auto tw-mt-2 sm:tw-mt-0<?= $replyButtonDisabled ? ' disabled' : ''; ?>"
                                <?= $replyButtonDisabled ? 'disabled="disabled" aria-disabled="true"' : ''; ?>
                                <?= $addResponseDisabled ? 'title="' . _l('ticket_closed_no_responses') . '"' : ''; ?>
