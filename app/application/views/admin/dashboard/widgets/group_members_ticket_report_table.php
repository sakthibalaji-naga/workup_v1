...
<table class="table dt-table table-group-members-tickets dt-inline dataTable no-footer" data-order-col="0" data-order-type="asc">
    <thead>
    <tr>
    ...
    <tbody>
    <?php foreach ($team_ticket_report as $staff) { ?>
        <tr>
            <td>
