...
<table class="table dt-table table-team-creation-ticket-reports dt-inline dataTable no-footer" data-order-col="0" data-order-type="asc">
    <thead>
    <tr>
        <th><?php echo _l('ticket_reports_staff'); ?></th>
        <th><?php echo _l('ticket_reports_total_created'); ?></th>
    ...
    <tbody>
    <?php foreach ($team_ticket_creation_report as $staff) { ?>
        <tr>
            <td>
            ...
            <td><?php echo e($staff->total_created); ?></td>
