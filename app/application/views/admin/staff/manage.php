        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tw-mb-2">
                    ...
                    <a href="<?php echo admin_url('staff/bulk_upload'); ?>" class="btn btn-info">
                        <i class="fa fa-upload tw-mr-1"></i>
                        <?php echo _l('bulk_upload_staff'); ?>
                    </a>
                    <?php } ?>
                    <a href="<?php echo admin_url('staff/sync_dashboard'); ?>" class="btn btn-success">
                        <i class="fa fa-sync tw-mr-1"></i>
                        <?php echo _l('staff_sync_button_label'); ?>
                    </a>
                </div>
                <div class="panel_s">
