    ...
    <div class="content" id="vueApp">
        ...
        <div class="row _buttons tw-mb-2">
            <div class="col-md-8">
                ...
                <a href="<?php echo admin_url('tasks/create' . ($this->input->get('project_id') ? '?rel_id=' . $this->input->get('project_id') . '&rel_type=project' : '')); ?>" class="btn btn-primary pull-left new">
                ...
                <a href="<?= admin_url('tasks/team_tasks'); ?>" class="btn btn-default tw-ml-1 pull-left hidden-xs !tw-px-3"
                    data-toggle="tooltip" data-placement="top" data-title="<?= _l('team_tasks'); ?>">
