...
<div id="calendar_filters" style="<?php if(!$this->input->post('calendar_filters')){ echo 'display:none;'; } ?>">
    ...
    <div class="col-md-3">
        ...
        <div class="checkbox">
            <input type="checkbox" value="1" name="my_tickets" id="cf_my_tickets"<?php if($this->input->post('my_tickets')){echo ' checked';} ?>>
            <label for="cf_my_tickets"><?php echo _l('my_tickets'); ?></label>
        </div>
        <div class="checkbox">
            <input type="checkbox" value="1" name="my_team_tickets" id="cf_my_team_tickets"<?php if($this->input->post('my_team_tickets')){echo ' checked';} ?>>
            <label for="cf_my_team_tickets"><?php echo _l('my_team_tickets'); ?></label>
        </div>
        <div class="checkbox">
            <input type="checkbox" value="1" name="my_team_creation_tickets" id="cf_my_team_creation_tickets"<?php if($this->input->post('my_team_creation_tickets')){echo ' checked';} ?>>
            <label for="cf_my_team_creation_tickets"><?php echo _l('my_team_creation_tickets'); ?></label>
        </div>
