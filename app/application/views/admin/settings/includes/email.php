...
<div class="horizontal-scrollable-tabs panel-full-width-tabs">
    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            ...
            <li role="presentation">
                <a href="#email_templates" aria-controls="email_templates" role="tab"
                    data-toggle="tab"><?= _l('email_templates'); ?></a>
            </li>
        </ul>
    </div>
</div>
...
?>
    ...
    <div role="tabpanel" class="tab-pane" id="email_templates">
        <h4 class="mbot15">
            <?= _l('email_templates'); ?>
        </h4>
        <p class="text-muted mbot20">
            <?= _l('manage_email_templates_desc'); ?>
        </p>

        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info">
                    <p><strong><?= _l('note'); ?>:</strong> <?= _l('email_templates_managed_from_dedicated'); ?> <a href="<?= admin_url('emails'); ?>" target="_blank"><?= _l('email_templates'); ?></a> <?= _l('section'); ?>.</p>
                </div>

                <a href="<?= admin_url('emails'); ?>" class="btn btn-primary btn-lg" target="_blank">
                    <i class="fa fa-envelope"></i> <?= _l('go_to_email_templates'); ?>
                </a>
            </div>
        </div>
    </div>
