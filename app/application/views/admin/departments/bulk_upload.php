            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="no-margin">Bulk Upload Departments</h4>
                        ...
                        <div id="upload-section">
                            <?php echo form_open_multipart(admin_url('departments/bulk_upload'), ['id' => 'bulk-upload-form']); ?>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="<?php echo site_url('sample_departments_upload.csv'); ?>" class="btn btn-success" download>
                                        <i class="fa fa-download"></i>
                                        Download Sample CSV
                                    </a>
                                    <a href="<?php echo admin_url('departments'); ?>" class="btn btn-default">
                        ...
                        <div id="preview-section" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <?php echo form_open(admin_url('departments/bulk_upload'), ['id' => 'import-form']); ?>
                                    ...
                                    <button type="submit" id="import-btn" class="btn btn-success" disabled>
                                        ...
                                        (<span id="import-count">0</span> <?php echo _l('departments'); ?>)
                                    </button>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <ul>
                                        <li><code>name</code> - <?php echo _l('department_name'); ?></li>
                                    </ul>
                                    <strong><?php echo _l('optional_columns'); ?>:</strong>
                                    <ul>
                                        <li><code>department_name</code> - <?php echo _l('department_name'); ?> (<?php echo _l('alternative_column_name'); ?>)</li>
                                        <li><code>division</code> - <?php echo _l('division'); ?> (<?php echo _l('division_name_exact_match'); ?>)</li>
                                        <li><code>division_name</code> - <?php echo _l('division'); ?> (<?php echo _l('alternative_column_name'); ?>)</li>
                                        <li><code>parent_department</code> - <?php echo _l('parent_department'); ?> (<?php echo _l('department_name_exact_match'); ?>)</li>
                                        <li><code>parent_department_name</code> - <?php echo _l('parent_department'); ?> (<?php echo _l('alternative_column_name'); ?>)</li>
                                    </ul>
                                    <p><strong><?php echo _l('sample_csv_format'); ?>:</strong></p>
                                    <pre>name,division,parent_department
IT Department,IT Division,
HR Department,HR Division,
Finance Department,Finance Division,
Operations Department,Operations Division,IT Department
Marketing Department,Marketing Division,
Sales Department,Sales Division,Marketing Department</pre>
                                </div>

                                <div class="alert alert-success">
                                    <h5><i class="fa fa-info-circle"></i> <?php echo _l('two_step_process'); ?></h5>
                                    <p><?php echo _l('departments_bulk_upload_two_step_desc'); ?></p>
                                    <ol>
                                        <li><strong><?php echo _l('step_1_create_departments'); ?>:</strong> <?php echo _l('create_missing_departments_without_hierarchy'); ?></li>
                                        <li><strong><?php echo _l('step_2_update_relationships'); ?>:</strong> <?php echo _l('update_parent_department_relationships'); ?></li>
                                    </ol>
                                    <p><em><?php echo _l('existing_departments_note'); ?>: <?php echo _l('existing_departments_will_be_updated'); ?></em></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(function() {
    ...
    function processCSV(csvText) {
        ...
        for (var i = 0; i < csvHeaders.length; i++) {
            ...
            if (requiredColumns.includes(header) || header === 'department_name') {
                foundRequired++;
            }
        }

        if (foundRequired < 1) {
            alert('File must contain a name or department_name column.');
            $('#preview-btn').prop('disabled', false).html('<i class="fa fa-eye"></i> Preview Data');
            return;
        }
    ...
    function validateRow(row, rowNumber) {
        ...
        if (!name && getColumnValue(row, columnMap, 'department_name')) {
            name = getColumnValue(row, columnMap, 'department_name');
        }
        ...
        if (name && name.length > 191) {
            errors.push('Row ' + rowNumber + ': Department name is too long (maximum 191 characters).');
        }
    ...
    $('#import-form').on('submit', function(e) {
        ...
        if (!confirm('Are you sure you want to import these departments? This action cannot be undone.')) {
            e.preventDefault();
            return false;
        }
